...
eksctl create cluster -f kcd-it23-eu-central-1.yaml
# Create the EKS cluster in the eu-west-1 region
eksctl create cluster -f kcd-it23-eu-west-1.yaml
